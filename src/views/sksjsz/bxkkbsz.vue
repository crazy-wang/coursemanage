    ...
    <div class="params-setting">
      <el-card>
        ...
        <el-row :span="20">
          <el-col :span="7">
            <div class="item">
              <span class="title">上午课节数</span>
              <el-input v-model="swNum"></el-input>
              <span class="red-tips">*最小值为1</span>
            </div>
          </el-col>
          <el-col :span="7">
            <div class="item">
              <span class="title">下午课节数</span>
              <el-input v-model="xwNum"></el-input>
              <span class="red-tips">*最小值为1</span>
            </div>
          </el-col>
          <el-col :span="7">
            <div class="item">
              <span class="title">晚上课节数</span>
              <el-input v-model="wsNum"></el-input>
              <span class="red-tips">*最小值为1</span>
            </div>
          </el-col>
          <el-col :span="2">
            <el-button type="primary" @click="saveParamsSetting">保存参数</el-button>
          </el-col>
        </el-row>
      </el-card>
    </div>
...
export default {
    ...
    methods: {
      ...
      async loadParamsSetting() {
        let res = await this.axios.get('v1/sksj/getSetting',{
          params: {
            token: getToken()
          }
        })
        ...
        this.swNum = resData.AmNum
        this.xwNum = resData.PmNum
        this.wsNum = resData.NightNum
      },
      async saveParamsSetting() {
        let params = {
          token: getToken(),
          AmNum: this.swNum,
          PmNum: this.xwNum,
        ...
        let res = await this.axios.post('v1/sksj/save', params)
        // console.log('保存参数')
        // console.log(res)
        let resData = res.data.code
        if (resData === 200) {
